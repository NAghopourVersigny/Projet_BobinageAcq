...
class INA219
{
    ...
    private:
        ...
        // jd: changed to bool to report errors to callers
        bool        write_register(uint8_t register_address, uint16_t register_value);
    ...
    public:
        ...
        * @param shunt_adc The shunt ADC resolution (9, 10, 11, or 12-bit) or
                            ...
                            ADC_2SAMP, ADC_4SAMP, ADC_8SAMP, ADC_16SAMP,
                            ADC_32SAMP, ADC_64SAMP, ADC_128SAMP.
        * @return bool true if init was successful, false on error, e.g. ina219 not present
        */
        bool configure(int voltage_range, int gain, int bus_adc, int shunt_adc);
